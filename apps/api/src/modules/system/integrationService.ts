...
import automationService from '../automation/workflows/AutomationService';
import chatbotService from '../ai/assistant/ChatbotService';
...
class IntegrationService {
     ...
     */
    async handleWhatsAppLead(tenantId: any, payload: any, io: any) {
     ...
     */
    async handleFacebookLead(tenantId: any, payload: any, io: any) {
     ...
     */
    async handleGoogleLead(tenantId: any, payload: any, io: any) {
     ...
     */
    async handleGenericLead(tenantId: any, payload: any, source = 'External', io: any) {
        return await this.createLeadFromIntegration({
            tenant_id: tenantId,
     ...
     */
    async createLeadFromIntegration(leadData: any, io: any) {
...
In the meantime, feel free to ask any questions here!`;
     ...
     */
    async syncContacts(tenantId: any, apiKey: any) {
