  ...
  return (
    <div className="dash-premium-container" style={{ padding: isMobile ? '16px' : '24px 32px', margin: isMobile ? undefined : '-16px -28px -28px -28px' }}>
      <style>{`
        ...
        @media (max-width: 1200px) { .dash-row-grid { grid-template-columns: 1fr; } .col-span-7,.col-span-8,.col-span-10,.col-span-12,.col-span-14,.col-span-17,.col-span-24 { grid-column: span 1; } }
