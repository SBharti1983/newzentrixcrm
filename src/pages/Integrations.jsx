...
export default function Integrations() {
    ...
    const handleTestIntegration = async (provider) => {
        try {
            ...
            const response = await fetch(`${import.meta.env.VITE_API_URL || 'http://localhost:4000/api'}/webhooks/${integration.webhook_url_key}/${provider.id === 'meta' ? 'facebook' : provider.id}`, {
                method: 'POST',
