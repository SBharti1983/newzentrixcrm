...
import { sendWelcomeEmail, sendReferralAlert } from '../services/notifier';
...
router.post('/signup', async (req: Request, res: Response) => {
    ...
    try {
        ...
        await pool.query(
            ...
            ['self_signup', tenant.id, JSON.stringify({ name, email, slug, referral_code })]
        );
...
router.get('/tenant-identity', async (req: Request, res: Response) => {
